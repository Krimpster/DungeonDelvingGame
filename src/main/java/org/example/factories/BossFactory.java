...
public class BossFactory implements IFactoryMonster {
    ...
    public Monster createMonster(String name, int hp, int baseAttack, int baseDefense, int baseFocusPoints,
        ...
        return new BossMonster(name, hp, baseAttack, baseDefense, baseFocusPoints, focusPoints, focusPointsPerTurn, skillDamageVariance, monsterSkill, bossSkill, expReward);
    }
}
